...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='%(prog)s shows the loss and metric graphs with data generated by fc_uvests_fit.py with argument --dumpout')
    ...
    parser.add_argument('--dump',
                        ...
                        dest='dump_path',
                        required=True,
                        help='dump directory (generated by any fitting/training scripts of this suite that support --dumpout argument)')
